...
namespace Fantasy.Entitas.Interface
{
    ...
    internal interface IDeserializeSystemAsync : IEntitiesSystemAsync { }
    /// <summary>
    /// 实体的反序列化事件的抽象接口
    /// </summary>
    ...
    /// </summary>
    /// <typeparam name="T">实体的泛型数据</typeparam>
    public abstract class DeserializeSystemAsync<T> : IDeserializeSystemAsync where T : Entity
    {
        /// <summary>
        /// 实体的类型
        /// </summary>
        ...
        /// </summary>
        /// <param name="self">触发事件的实体实例</param>
        protected abstract FTask Deserialize(T self);
        /// <summary>
        /// 框架内部调用的触发Deserialize的方法
        /// </summary>
        /// <param name="self">触发事件的实体实例</param>
