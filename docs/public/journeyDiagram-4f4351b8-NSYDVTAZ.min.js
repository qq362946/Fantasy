...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},lex:function(){var a=this.next();return a||this.lex()},begin:function(a){this.conditionStack.push(a)},popState:function(){var a=this.conditionStack.length-1;return a>0?this.conditionStack.pop():this.conditionStack[0]},_currentRules:function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},topState:function(a){return a=this.conditionStack.length-1-Math.abs(a||0),a>=0?this.conditionStack[a]:"INITIAL"},pushState:function(a){this.begin(a)},stateStackSize:function(){return this.conditionStack.length},options:{"case-insensitive":!0},performAction:function(a,h,d,m){switch(d){case 0:return this.begin("open_directive"),26;case 1:return this.begin("type_directive"),27;case 2:return this.popState(),this.begin("arg_directive"),15;case 3:return this.popState(),this.popState(),29;case 4:return 28;case 5:break;case 6:break;case 7:return 11;case 8:break;case 9:break;case 10:return 4;case 11:return 17;case 12:return this.begin("acc_title"),18;case 13:return this.popState(),"acc_title_value";case 14:return this.begin("acc_descr"),20;case 15:return this.popState(),"acc_descr_value";case 16:this.begin("acc_descr_multiline");break;case 17:this.popState();break;case 18:return"acc_descr_multiline_value";case 19:return 23;case 20:return 24;case 21:return 25;case 22:return 15;case 23:return 6;case 24:return"INVALID"}},rules:[/^(?:%%\{)/i,/^(?:((?:(?!\}%%)[^:.])*))/i,/^(?::)/i,/^(?:\}%%)/i,/^(?:((?:(?!\}%%).|\n)*))/i,/^(?:%(?!\{)[^\n]*)/i,/^(?:[^\}]%%[^\n]*)/i,/^(?:[\n]+)/i,/^(?:\s+)/i,/^(?:#[^\n]*)/i,/^(?:journey\b)/i,/^(?:title\s[^#\n;]+)/i,/^(?:accTitle\s*:\s*)/i,/^(?:(?!\n||)*[^\n]*)/i,/^(?:accDescr\s*:\s*)/i,/^(?:(?!\n||)*[^\n]*)/i,/^(?:accDescr\s*\{\s*)/i,/^(?:[\}])/i,/^(?:[^\}]*)/i,/^(?:section\s[^#:\n;]+)/i,/^(?:[^#:\n;]+)/i,/^(?::[^#\n;]+)/i,/^(?::)/i,/^(?:$)/i,/^(?:.)/i],conditions:{open_directive:{rules:[1],inclusive:!1},type_directive:{rules:[2,3],inclusive:!1},arg_directive:{rules:[3,4],inclusive:!1},acc_descr_multiline:{rules:[17,18],inclusive:!1},acc_descr:{rules:[15],inclusive:!1},acc_title:{rules:[13],inclusive:!1},INITIAL:{rules:[0,5,6,7,8,9,10,11,12,14,16,19,20,21,22,23,24],inclusive:!0}}};return _}();p.lexer=T;function v(){this.yy={}}return v.prototype=p,p.Parser=v,new v}();Q.parser=Q;var Ct=Q,L="",tt=[],N=[],B=[],Vt=function(t,e,s){gt.parseDirective(this,t,e,s)},Ft=function(){tt.length=0,N.length=0,L="",B.length=0,lt()},Lt=function(t){L=t,tt.push(t)},Rt=function(){return tt},Nt=function(){let t=mt(),e=100,s=0;for(;!t&&s<e;)t=mt(),s++;return N.push(...B),N},Bt=function(){let t=[];return N.forEach(s=>{s.people&&t.push(...s.people)}),[...new Set(t)].sort()},jt=function(t,e){let s=e.substr(1).split(":"),n=0,i=[];s.length===1?(n=Number(s[0]),i=[]):(n=Number(s[0]),i=s[1].split(","));let l=i.map(y=>y.trim()),o={section:L,type:L,people:l,task:t,score:n};B.push(o)},zt=function(t){let e={section:L,type:L,description:t,task:t,classes:[]};N.push(e)},mt=function(){let t=function(s){return B[s].processed},e=!0;for(let[s,n]of B.entries())t(s),e=e&&n.processed;return e},Yt=function(){return Bt()},xt={parseDirective:Vt,getConfig:()=>I().journey,clear:Ft,setDiagramTitle:dt,getDiagramTitle:ft,setAccTitle:ht,getAccTitle:ut,setAccDescription:yt,getAccDescription:pt,addSection:Lt,getSections:Rt,getTasks:Nt,addTask:jt,addTaskOrg:zt,getActors:Yt},qt=t=>`.label {
...
`,Ot=qt,et=function(t,e){return nt(t,e)},Dt=function(t,e){let n=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),i=t.append("g");i.append("circle").attr("cx",e.cx-15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),i.append("circle").attr("cx",e.cx+15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function l(u){let x=Z().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);u.append("path").attr("class","mouth").attr("d",x).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}function o(u){let x=Z().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);u.append("path").attr("class","mouth").attr("d",x).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}function y(u){u.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return e.score>3?l(i):e.score<3?o(i):y(i),n},bt=function(t,e){let s=t.append("circle");return s.attr("cx",e.cx),s.attr("cy",e.cy),s.attr("class","actor-"+e.pos),s.attr("fill",e.fill),s.attr("stroke",e.stroke),s.attr("r",e.r),s.class!==void 0&&s.attr("class",s.class),e.title!==void 0&&s.append("title").text(e.title),s},wt=function(t,e){return ot(t,e)},Wt=function(t,e){function s(i,l,o,y,u){return i+","+l+" "+(i+o)+","+l+" "+(i+o)+","+(l+y-u)+" "+(i+o-u*1.2)+","+(l+y)+" "+i+","+(l+y)}let n=t.append("polygon");n.attr("points",s(e.x,e.y,50,20,7)),n.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,wt(t,e)},Xt=function(t,e,s){let n=t.append("g"),i=J();i.x=e.x,i.y=e.y,i.fill=e.fill,i.width=s.width*e.taskCount+s.diagramMarginX*(e.taskCount-1),i.height=s.height,i.class="journey-section section-type-"+e.num,i.rx=3,i.ry=3,et(n,i),Tt(s)(e.text,n,i.x,i.y,i.width,i.height,{class:"journey-section section-type-"+e.num},s,e.colour)},_t=-1,Gt=function(t,e,s){let n=e.x+s.width/2,i=t.append("g");_t++;let l=300+5*30;i.append("line").attr("id","task"+_t).attr("x1",n).attr("y1",e.y).attr("x2",n).attr("y2",l).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),Dt(i,{cx:n,cy:300+(5-e.score)*30,score:e.score});let o=J();o.x=e.x,o.y=e.y,o.fill=e.fill,o.width=s.width,o.height=s.height,o.class="task task-type-"+e.num,o.rx=3,o.ry=3,et(i,o);let y=e.x+14;e.people.forEach(u=>{let x=e.actors[u].color,g={cx:y,cy:e.y,r:7,fill:x,stroke:"#000",title:u,pos:e.actors[u].position};bt(i,g),y+=10}),Tt(s)(e.task,i,o.x,o.y,o.width,o.height,{class:"task"},s,e.colour)},Ht=function(t,e){at(t,e)},Tt=function(){function t(i,l,o,y,u,x,g,f){let p=l.append("text").attr("x",o+u/2).attr("y",y+x/2+5).style("font-color",f).style("text-anchor","middle").text(i);n(p,g)}function e(i,l,o,y,u,x,g,f,p){let{taskFontSize:T,taskFontFamily:v}=f,_=i.split(/<br\s*\/?>/gi);for(let r=0;r<_.length;r++){let a=r*T-T*(_.length-1)/2,h=l.append("text").attr("x",o+u/2).attr("y",y).attr("fill",p).style("text-anchor","middle").style("font-size",T).style("font-family",v);h.append("tspan").attr("x",o+u/2).attr("dy",a).text(_[r]),h.attr("y",y+x/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),n(h,g)}}function s(i,l,o,y,u,x,g,f){let p=l.append("switch"),v=p.append("foreignObject").attr("x",o).attr("y",y).attr("width",u).attr("height",x).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");v.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(i),e(i,p,o,y,u,x,g,f),n(v,g)}function n(i,l){for(let o in l)o in l&&i.attr(o,l[o])}return function(i){return i.textPlacement==="fo"?s:i.textPlacement==="old"?t:e}}(),Ut=function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},j={drawRect:et,drawCircle:bt,drawSection:Xt,drawText:wt,drawLabel:Wt,drawTask:Gt,drawBackgroundRect:Ht,initGraphics:Ut},Zt=function(t){Object.keys(t).forEach(function(s){D[s]=t[s]})},P={};function Jt(t){let e=I().journey,s=60;Object.keys(P).forEach(n=>{let i=P[n].color,l={cx:20,cy:s,r:7,fill:i,stroke:"#000",pos:P[n].position};j.drawCircle(t,l);let o={x:40,y:s+7,fill:"#666",text:n,textMargin:e.boxTextMargin|5};j.drawText(t,o),s+=20})}var D=I().journey,V=D.leftMargin,Kt=function(t,e,s,n){let i=I().journey;n.db.clear(),n.parser.parse(t+`
`);let l=I().securityLevel,o;l==="sandbox"&&(o=O("#i"+e));let y=l==="sandbox"?O(o.nodes()[0].contentDocument.body):O("body");S.init();let u=y.select("#"+e);j.initGraphics(u);let x=n.db.getTasks(),g=n.db.getDiagramTitle(),f=n.db.getActors();for(let a in P)delete P[a];let p=0;f.forEach(a=>{P[a]={color:i.actorColours[p%i.actorColours.length],position:p},p++}),Jt(u),S.insert(0,0,V,Object.keys(P).length*50),Qt(u,x,0);let T=S.getBounds();g&&u.append("text").text(g).attr("x",V).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);let v=T.stopy-T.starty+2*i.diagramMarginY,_=V+T.stopx+2*i.diagramMarginX;ct(u,v,_,i.useMaxWidth),u.append("line").attr("x1",V).attr("y1",i.height*4).attr("x2",_-V-4).attr("y2",i.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");let r=g?70:0;u.attr("viewBox",`${T.startx} -25 ${_} ${v+r}`),u.attr("preserveAspectRatio","xMinYMin meet"),u.attr("height",v+r+25)},S={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},updateVal:function(t,e,s,n){t[e]===void 0?t[e]=s:t[e]=n(s,t[e])},updateBounds:function(t,e,s,n){let i=I().journey,l=this,o=0;function y(u){return function(g){o++;let f=l.sequenceItems.length-o+1;l.updateVal(g,"starty",e-f*i.boxMargin,Math.min),l.updateVal(g,"stopy",n+f*i.boxMargin,Math.max),l.updateVal(S.data,"startx",t-f*i.boxMargin,Math.min),l.updateVal(S.data,"stopx",s+f*i.boxMargin,Math.max),u!=="activation"&&(l.updateVal(g,"startx",t-f*i.boxMargin,Math.min),l.updateVal(g,"stopx",s+f*i.boxMargin,Math.max),l.updateVal(S.data,"starty",e-f*i.boxMargin,Math.min),l.updateVal(S.data,"stopy",n+f*i.boxMargin,Math.max))}}this.sequenceItems.forEach(y())},insert:function(t,e,s,n){let i=Math.min(t,s),l=Math.max(t,s),o=Math.min(e,n),y=Math.max(e,n);this.updateVal(S.data,"startx",i,Math.min),this.updateVal(S.data,"starty",o,Math.min),this.updateVal(S.data,"stopx",l,Math.max),this.updateVal(S.data,"stopy",y,Math.max),this.updateBounds(i,o,l,y)},bumpVerticalPos:function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},getVerticalPos:function(){return this.verticalPos},getBounds:function(){return this.data}},K=D.sectionFills,kt=D.sectionColours,Qt=function(t,e,s){let n=I().journey,i="",l=n.height*2+n.diagramMarginY,o=s+l,y=0,u="#CCC",x="black",g=0;for(let[f,p]of e.entries()){if(i!==p.section){u=K[y%K.length],g=y%K.length,x=kt[y%kt.length];let v=0,_=p.section;for(let a=f;a<e.length&&e[a].section==_;a++)v=v+1;let r={x:f*n.taskMargin+f*n.width+V,y:50,text:p.section,fill:u,num:g,colour:x,taskCount:v};j.drawSection(t,r,n),i=p.section,y++}let T=p.people.reduce((v,_)=>(P[_]&&(v[_]=P[_]),v),{});p.x=f*n.taskMargin+f*n.width+V,p.y=o,p.width=n.diagramMarginX,p.height=n.diagramMarginY,p.colour=x,p.fill=u,p.num=g,p.actors=T,j.drawTask(t,p,n),S.insert(p.x,p.y,p.x+p.width+n.taskMargin,300+5*30)}},vt={setConf:Zt,draw:Kt},oe={parser:Ct,db:xt,renderer:vt,styles:Ot,init:t=>{vt.setConf(t.journey),xt.clear()}};export{oe as diagram};
//# sourceMappingURL=journeyDiagram-4f4351b8-NSYDVTAZ.min.js.map
