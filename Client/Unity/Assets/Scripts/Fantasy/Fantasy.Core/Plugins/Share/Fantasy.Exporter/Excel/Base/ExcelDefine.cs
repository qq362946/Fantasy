...
public static class ExcelDefine
{
    ...
    /// 服务器代码生成文件夹
    /// </summary>
    public static string ServerFileDirectory = $"{ProjectPath}/Server/Fantasy.Model/Generate/ConfigTable/Entity/";
    /// <summary>
    /// 客户端代码生成文件夹
    /// </summary>
    public static string ClientFileDirectory = $"{ProjectPath}/Client/Unity/Assets/Scripts/Fantasy/Fantasy.Model/Generate/ConfigTable/Entity/";
    /// <summary>
    /// 服务器二进制数据文件夹
    /// </summary>
    ...
    /// 服务器自定义导出代码
    /// </summary>
    public static string ServerCustomExportDirectory = $"{ProjectPath}/Server/Fantasy.Model/Generate/CustomExport/";
    /// <summary>
    /// 客户端自定义导出代码
    /// </summary>
    public static string ClientCustomExportDirectory = $"{ProjectPath}/Client/Unity/Assets/Scripts/Fantasy/Fantasy.Model/Generate/CustomExport/";
    /// <summary>
    /// 导表支持的类型
    /// </summary>
