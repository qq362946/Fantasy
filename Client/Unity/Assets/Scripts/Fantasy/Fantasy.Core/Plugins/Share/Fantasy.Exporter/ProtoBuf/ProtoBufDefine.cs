...
public static class ProtoBufDefine
{
    ...
    /// 服务端生成文件夹
    /// </summary>
    public static string ServerDirectory = $"{ProjectPath}/Server/Fantasy.Model/Generate/NetworkProtocol/";
    /// <summary>
    /// 客户端生成文件夹
    /// </summary>
    public static string ClientDirectory = $"{ProjectPath}/Client/Unity/Assets/Scripts/Fantasy/Fantasy.Model/Generate/NetworkProtocol/";
    /// <summary>
    /// 代码模板路径
    /// </summary>
