...
namespace Fantasy.SourceGenerator.Generators
{
    ...
    public class AssemblyInitializerGenerator : IIncrementalGenerator
    {
            ...
            Compilation compilation)
        {
            ...
            GenerateInitializeMethod(builder, markerClassName, targetPlatform);
            // 生成卸载方法
        ...
        private static void GenerateInitializeMethod(SourceCodeBuilder builder, string markerClassName, int targetPlatform)
        {
            switch (targetPlatform)
            {
                case 1:     // Server (.NET)
