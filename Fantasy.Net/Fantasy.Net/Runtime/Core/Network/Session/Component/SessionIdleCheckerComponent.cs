...
public class SessionIdleCheckerComponent : Entity
{
    ...
    private void Check()
    {
        ...
        Log.Warning($"session timeout id:{_session.Id} runtimeId:{_session.RuntimeId} timeNow:{timeNow} _session.LastReceiveTime:{_session.LastReceiveTime} _timeOut:{_timeOut}");
        _session.Dispose();
    }
}
#endif