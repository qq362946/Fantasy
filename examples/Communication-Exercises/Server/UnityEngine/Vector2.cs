    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public override string ToString()
        {
            ...
            return string.Format(currentCulture, "{0}, {1}",
                new object[2] {x.ToString(currentCulture), y.ToString(currentCulture)});
        }
        ...
        {
            var num1 = (float) (x * (double) x + y * (double) y);
        ...
        {
            var num1 = (float) (value.x * (double) value.x + value.y * (double) value.y);
            if (num1 < 9.99999974737875E-06)
            {
                return value;
            }
        ...
        {
            Vector2 vector2;
            vector2.x = value1.x < (double) value2.x ? value1.x : value2.x;
            vector2.y = value1.y < (double) value2.y ? value1.y : value2.y;
            return vector2;
        }
        ...
        public static float Angle(Vector2 from, Vector2 to)
        {
            ...
            to.Normalize();
            float result;
            Dot(ref from, ref to, out result);
        ...
        public static void Angle(ref Vector2 from, ref Vector2 to, out float result)
        {
            ...
            to.Normalize();
            float result1;
            Dot(ref from, ref to, out result1);
