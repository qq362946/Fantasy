...
namespace UnityEngine
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        public static void Distance(ref Vector4 value1, ref Vector4 value2, out float result)
        {
            ...
            var num3 = value1.z - value2.z;
            var num4 = value1.w - value2.w;
            var num5 = (float) (num1 * (double) num1 + num2 * (double) num2 + num3 * (double) num3 +
                                num4 * (double) num4);
        ...
        public static float DistanceSquared(Vector4 value1, Vector4 value2)
        {
            ...
            var num3 = value1.z - value2.z;
            var num4 = value1.w - value2.w;
            return (float) (num1 * (double) num1 + num2 * (double) num2 + num3 * (double) num3 + num4 * (double) num4);
        }
        ...
        {
            var num1 = (float) (x * (double) x + y * (double) y + z * (double) z + w * (double) w);
        ...
        {
            var num1 = (float) (vector.x * (double) vector.x + vector.y * (double) vector.y +
        ...
        {
            Vector4 vector4;
            vector4.x = value1.x < (double) value2.x ? value1.x : value2.x;
            vector4.y = value1.y < (double) value2.y ? value1.y : value2.y;
            vector4.z = value1.z < (double) value2.z ? value1.z : value2.z;
            vector4.w = value1.w < (double) value2.w ? value1.w : value2.w;
            return vector4;
        }
        ...
        public static Vector4 Clamp(Vector4 value1, Vector4 min, Vector4 max)
        {
            ...
            var w = value1.w;
            var num7 = w > (double) max.w ? max.w : w;
            var num8 = num7 < (double) min.w ? min.w : num7;
            Vector4 vector4;
            vector4.x = num2;
            vector4.y = num4;
            vector4.z = num6;
