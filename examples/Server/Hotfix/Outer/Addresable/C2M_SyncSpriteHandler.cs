...
//namespace Fantasy
//{
//    internal class C2M_SyncSpriteHandler : Addressable<Unit, C2M_SyncSprite>
//    {
//        protected override async FTask Run(Unit unit, C2M_SyncSprite message)
//        {
...
//                        unit.Scene.NetworkMessagingComponent.SendInnerRoute(sceneConfig.RouteId, new M2G_SyncSprite()
//                        {
//                            ClientID = v,
