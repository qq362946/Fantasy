...
public class G2M_CreateSubSceneRequestHandler : AddressRPC<Scene, G2M_CreateSubSceneRequest, M2G_CreateSubSceneResponse>
{
    protected override async FTask Run(Scene scene, G2M_CreateSubSceneRequest request, M2G_CreateSubSceneResponse response, Action reply)
    {
        ...
        var subScene = await Scene.CreateSubScene(scene, SceneType.Map);
        // 返回subScene的运行时id
