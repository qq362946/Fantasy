...
namespace UnityEngine
{
    public struct Matrix3x3
    {
        ...
        {
            var fCofactor0 = Get(0, 0) * Get(1, 1) * Get(2, 2);
            var fCofactor1 = Get(0, 1) * Get(1, 2) * Get(2, 0);
            var fCofactor2 = Get(0, 2) * Get(1, 0) * Get(2, 1);

            var fCofactor3 = Get(0, 2) * Get(1, 1) * Get(2, 0);
            var fCofactor4 = Get(0, 1) * Get(1, 0) * Get(2, 2);
            var fCofactor5 = Get(0, 0) * Get(1, 2) * Get(2, 1);
