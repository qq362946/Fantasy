...
public static class ExporterHelper
{
    ...
    public static void Initialize()
    {
        ...
        ProtoBufDefine.ClientDirectory = $"{projectPath}/Client/Unity/Assets/Scripts/Fantasy/Fantasy.Model/Generate/NetworkProtocol/";
        // ProtoBuf生成代码模板的位置
        ...
        // Excel生成客户端代码文件夹位置
        ExcelDefine.ClientFileDirectory = $"{projectPath}/Client/Unity/Assets/Scripts/Fantasy/Fantasy.Model/Generate/ConfigTable/Entity/";
        ...
        // 客户端自定义导出代码文件夹位置
        ExcelDefine.ClientCustomExportDirectory = $"{projectPath}/Client/Unity/Assets/Scripts/Fantasy/Fantasy.Model/Generate/CustomExport/";
    }
}
#endif