...
#pragma warning restore CA2208 // param name - for clarity
        ...
        private readonly BasicList types = new() { }, basicTypes = new() { };
...
#pragma warning restore RCS1163, IDE0060, CA1822 // Unused parameter, static
        ...
        private readonly Hashtable _serviceCache = new() { };
...
#if PLAT_NO_EMITDLL || UNITY_2017_1_OR_NEWER
        ...
        private void WriteAssemblyAttributes(CompilerOptions options, string assemblyName, AssemblyBuilder asm)
        {
            if (!string.IsNullOrEmpty(options.TargetFrameworkName))
            {
                ...
                if (versionAttribType is not null)
                {
                    ...
                    {
                        props = new PropertyInfo[] { versionAttribType.GetProperty("FrameworkDisplayName") };
            ...
            {
                List<string> internalAssemblies = new() { };
                List<Assembly> consideredAssemblies = new() { };
                foreach (MetaType metaType in types)
                {
            ...
            static void WriteAssemblyInfoAttributes(CompilerOptions options, AssemblyBuilder asm)
            {
                    ...
                    where TAttribute : Attribute
                {
                    ...
                    Type[] ctorParameters = new Type[] { typeof(string) };
