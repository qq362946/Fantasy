...
namespace Fantasy.Network
{
    ...
    public static class OpCode
    {
        ...
        public const uint SubscribeSphereEventRequest = 1082130434;                 // Create(Bson=1, InnerRouteRequest=8, 2)
        public const uint SubscribeSphereEventResponse = 1216348162;                // Create(Bson=1, InnerRouteResponse=9, 2)
        public const uint UnsubscribeSphereEventRequest = 1082130435;               // Create(Bson=1, InnerRouteRequest=8, 3)
        public const uint UnsubscribeSphereEventResponse = 1216348163;              // Create(Bson=1, InnerRouteResponse=9, 3)
        public const uint RevokeRemoteSubscriberRequest = 1082130436;               // Create(Bson=1, InnerRouteRequest=8, 4)
        public const uint RevokeRemoteSubscriberResponse = 1216348164;              // Create(Bson=1, InnerRouteResponse=9, 4)
        public const uint PublishSphereEventRequest = 1082130437;                   // Create(Bson=1, InnerRouteRequest=8, 5)
        public const uint PublishSphereEventResponse = 1216348165;                  // Create(Bson=1, InnerRouteResponse=9, 5)
